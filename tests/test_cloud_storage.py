...
async def test_create_storage_client_success():
    ...
    # Act
    with patch("gemini_scribe.services.cloud_storage.Storage") as mock_storage_class:
        mock_storage_instance = AsyncMock()
        mock_storage_class.return_value = mock_storage_instance

        from gemini_scribe.services.cloud_storage import create_storage_client
...
async def test_get_storage_bucket():
    ...
    # Act
    with patch(
        "gemini_scribe.services.cloud_storage.create_storage_client"
